...
___________________________________________________________________
		...
		Training Kit (Exam 70-462): Administering a 
		  Microsoft® SQL Server® 2012 Database

                  by  Orin Thomas, Peter Ward, and Bob Taylor

               Copyright (c) 2012 by Microsoft Corporation
                      
         Portions copyright (c) 2012 by Orin Thomas and Peter Ward
                         All Rights Reserved
...
- Training Kit (Exam 70-462): Administering a Microsoft® SQL Server® 2012 Database eBook
- Practice Tests
- SQL Server 2012 Sample Databases Links
...
searchable electronic book in PDF format. To view this eBook, open the PDF file in 
the \eBook folder.
...
practice tests for Exam 70-462, is contained on this CD in the
...
SQL Server 2012 Sample Databases Links
--------------------------------------
The SQL Server 2012 sample databases that are needed to complete the
book exercises can be accessed from the links to the book's companion 
content page.
...
---------------------------------------------
Microsoft Press Technical Support Information
---------------------------------------------
...
http://go.microsoft.com/FWLink/?Linkid=251255
...
third-party Websites for the latest version of their software.
